...
// canvas list (maintained by live2d), canvas id, socket id, chosen model object
function Simple(canvas, canvasId, no, modelObj) {
    ...
    */
    ...
    this.modelDef = this.renderDataObj.aspect.modelDef;
    // haru2.0モデル
    // this.modelDef = {
    ...
    //     "type":"Live2D Model Setting",
    //     "name":"shizuku",
    //     "model":"assets/shizuku/shizuku.moc",
    //     "textures":[
    //         "assets/shizuku/shizuku.1024/texture_00.png",
    //         "assets/shizuku/shizuku.1024/texture_01.png",
    //         "assets/shizuku/shizuku.1024/texture_02.png",
    //         "assets/shizuku/shizuku.1024/texture_03.png",
    //         "assets/shizuku/shizuku.1024/texture_04.png",
    //         "assets/shizuku/shizuku.1024/texture_05.png"
    //     ]
    // };
...
Simple.prototype.draw = function(gl/* WebGLコンテキスト */)
{
    ...
    // smile or not: -1 = sad mouth, 1 = happy mouth
